  ...
  const [selected, setSelected] = useState(0);
    ...
    <Box bg="white" safeAreaTop width="100%"  alignSelf="center">
      <HStack bg="indigo.600" alignItems="center" safeAreaBottom shadow={6}>
        <Pressable cursor="pointer" opacity={selected === 0 ? 1 : 0.5} py="2" flex={1} onPress={() =>  { setSelected(0);navigation.navigate("Exercise");}}>
          <Center>
        ...
        <Pressable cursor="pointer" opacity={selected === 1 ? 1 : 0.5} py="2" flex={1} onPress={() => { setSelected(1);navigation.navigate("TeamList");}}>
          <Center>
